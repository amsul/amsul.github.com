...
<p class="contain"><input type="text" name="author" id="author" value="<?php
      echo $comment_author;
...
<p class="contain"><input type="text" name="email" id="email" value="<?php
  echo $comment_author_email;
?>" size="22" tabindex="2" <?php
  if ($req)
      echo "aria-required='true'";
?> />
<label for="email"><small>Mail <?php
  if ($req)
      echo "(required)";
?></small></label></p>

<p class="contain"><input type="text" name="url" id="url" value="<?php

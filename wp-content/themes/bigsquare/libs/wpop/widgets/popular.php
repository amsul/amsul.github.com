...
/**
 * Widget popular posts extends from WPop_Widget
 *
 * @package    Wordspop
 * @subpackage  Wordspop_Framework
 * @copyright  Copyright (c) 2010-2011 Wordspop
 ...
 * @since      1.0-beta6
 */
class WPop_Widget_Popular extends WPop_Widget
{
    ...
    public function widget( $args, $instance )
    {
        ...
        $query = new WP_Query("showposts={$instance['count']}&orderby=comment_count");
        $html = '<ul>' . "\n";

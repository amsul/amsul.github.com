...
class WPSDTwitterSearch {
     ...
     * @var array
     */
    var $headers= array('X-Twitter-Client: WPSDTwitterSearch', 'X-Twitter-Client-Version: 0.1'); //, 'X-Twitter-Client-URL: http://wpsd/twittersearch' //array('X-Twitter-Client: PHPTwitterSearch','X-Twitter-Client-Version: 0.1','X-Twitter-Client-URL: http://wpsd/twittersearch');
    ...
    */
    function WPSDTwitterSearch($query=false) {
        $this->query = $query;
    }

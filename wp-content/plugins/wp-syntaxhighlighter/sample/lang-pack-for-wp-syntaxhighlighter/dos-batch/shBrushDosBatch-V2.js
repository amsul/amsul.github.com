 ...
 */
SyntaxHighlighter.brushes.dosbatch = function()
{
...
SyntaxHighlighter.brushes.dosbatch.prototype	= new SyntaxHighlighter.Highlighter();
SyntaxHighlighter.brushes.dosbatch.aliases	= ['dosbatch', 'batch'];
